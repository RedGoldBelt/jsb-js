...
}).setKey("C major").parse("[C5|A4 F4 G4 C5|C5 B4 C5@ D5|E5 C5 D5 B4|C5_.@]", "s").harmonise();
...
}).setKey("F# minor").parse("[F#4 F#4 F#4 G#4|A4 G#4 F#4_|D4 F#4 F#4 E#4|F#4__]", "s").harmonise();
