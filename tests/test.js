...
const GSTQ = new JSB.Piece("G major", "[G4 G A|F#. G/ A|B@ B C|B. A/ G|A G F#|G_.@]").harmonise({debug:true});
...
//     dictionary: JSB.DICTIONARY_PRIMARY_a_b
// });
...
// const BWV_3_6 = new JSB.Piece(
//     "A major",
//     "[A4|A A F# A|B G# F#@ F#|G# A B E4/ F#/|G# F# E@ B4]",
//     null,
//     null,
//     "[A3|A2 C# D F#|D# E B@ B3|G# F# E G#/ A/|B B2 E@ E]"
// ).harmonise({
//     debug: true
// });
