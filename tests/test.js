...
const EXERCISE_V2 = new Piece().setKey(Key.parse("C major")).parse("[C5|A4 F4 G4 C5|C5 B4 C5; D5|E5 C5 D5 B4|C5_.;]", "s").configure("dictionary", new DictionaryPrimaryAB());
...
const PRIMARY_AB_TEST = new Piece().setKey(Key.parse("F# minor")).parse("[F#4 F#4 F#4 G#4|A4 G#4 F#4_|D4 F#4 F#4 E#4|F#4__]", "s").configure("dictionary", new DictionaryPrimaryAB());
