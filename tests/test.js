...
const PRIMARY_AB_TEST = new Piece().setKey(Key.parse("F# minor")).parse("[F#4 F#4 F#4 G#4|A4 G#4 F#4_|D4 F#4 F#4 E#4|F#4__]", "s").setDictionary(Dict.PRIMARY_AB);
const CHOPIN_ = new Piece().setKey(Key.parse("Bb major")).parse("[Bb4 Bb4/. C5// D5 Bb4|G4 C5/ Bb4/ A4_]", "s");
