...
const M1 = new JSB.Piece("C major", "[C5|A F G C|C B C@ D|E C D B|C_.@]").harmonise(JSB.DICTIONARY_FULL);
const M1_SIMPLE = new JSB.Piece("C major", "[C5|A F G C|C B C@ D|E C D B|C_.@]").harmonise(JSB.DICTIONARY_PRIMARY_a_b);
const KMSR = new JSB.Piece("D major", "[A4|F# F# G|A D A|G E5 A4|F#_@ A|D C# B|A. G/ F#|E D C#|D_@]").harmonise(JSB.DICTIONARY_FULL);
const C2 = new JSB.Piece("A major", "[C#5|A B C# F#|E C# B_@|D D C# C#|B B A_@]").harmonise(JSB.DICTIONARY_FULL);
