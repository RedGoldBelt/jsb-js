...
export default class Inversions<T> {
    ...
    get(inversion: Util.Inversion) {
        switch (inversion) {
            ...
            case 3: return this.seventh as T;
        }
    }

    set(inversion: Util.Inversion, value: T) {
        switch (inversion) {
            case 0: return this.root = value;
            case 1: return this.third = value;
            case 2: return this.fifth = value;
            case 3: return this.seventh = value;
        }
    }
}
